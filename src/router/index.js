...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      component: require('@/components/SharedWallet/SharedWalletDetail')
        .default,
      children: [
        {
          path: 'home',
          name: 'SHaredWalletHome',
          component: require('@/components/SharedWallet/SharedWalletHome')
            .default
        },
        {
          path: '/sharedWallet/sendTransfer',
          component: require('@/components/SharedWallet/SharedWalletSend')
            .default
        },
        {
        ...
        },
        {
          ...
          component: require('@/components/SharedWallet/View/SharedWalletCopayer')
            .default
        },
        {
        ...
        },
        {
          ...
          name: 'StartProcess',
          component: require('@/components/SharedWallet/PAX/StartProcess')
            .default
        },
        {
          path: '/sharedWallet/signProcess',
          name: 'SignProcess',
          component: require('@/components/SharedWallet/PAX/SignProcess')
            .default
        },
        {
          path: '/sharedWallet/txMgmt',
          name: 'SharedTxMgmt',
          component: require('@/components/SharedWallet/Tx/SharedTxMgmt')
            .default
        }
      ]
    },
    ...
    },
    {
      ...
      component: require('@/components/Node/NodeStake/NodeStakeRegister')
        .default
    },
    {
    ...
    // },
    {
      ...
      component: require('@/components/Node/NodeManagement/NodeStakeManagement')
        .default
    },
    {
      path: '/node/nodeList',
    ...
    },
    {
      ...
      name: 'AuthorizeLogin',
      component: require('@/components/Node/NodeAuthorize/AuthorizeLogin')
        .default
    },
    {
      path: '/dapps/authorizeLoginSesameseed',
      name: 'AuthorizeLoginSesameseed',
      component: require('@/components/Node/NodeAuthorize/Sesameseed/AuthorizeLoginSesameseed')
        .default
    },
    {
      path: '/node/authorizationMgmt',
      name: 'AuthorizationMgmt',
      component: require('@/components/Node/NodeAuthorize/AuthorizationMgmt')
        .default
    },
    {
      path: '/dapps/authorizationMgmtSesameseed',
      name: 'AuthorizationMgmtSesameseed',
      component: require('@/components/Node/NodeAuthorize/Sesameseed/AuthorizationMgmtSesameseed')
        .default
    },
    {
      path: '/node/newAuthorization',
      name: 'NewAuthorization',
      component: require('@/components/Node/NodeAuthorize/NewAuthorization')
        .default
    },
    {
      path: '/dapps/newAuthorizationSesameseed',
      name: 'NewAuthorizationSesameseed',
      component: require('@/components/Node/NodeAuthorize/Sesameseed/NewAuthorizationSesameseed')
        .default
    },
    {
      path: '/oep4Home',
