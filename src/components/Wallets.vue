    ...
    <div class="tab-content" id="pills-tabContent">
      ...
      >
        <div class="d-flex flex-wrap align-content-start center">
          ...
          <div
            class="div-create-wallet"
            :class="[viewBtn ? 'div-create-wallet-bg-color' : '']"
            v-on:mouseenter="viewAllBtn(true)"
            v-on:mouseleave="viewAllBtn(false)"
          >
            <div class="div-create" v-show="viewBtn">
              <router-link
                class="btn btn-default btn-create"
                :to="{ name: 'CreateJsonWallet' }"
            ...
            <div class="div-join" v-show="viewBtn">
              <router-link
                class="btn btn-default btn-create"
                :to="{ name: 'ImportJsonWallet' }"
                >{{ $t('wallets.importCommonWallet') }}</router-link
              >
            </div>
            <img
              class="img-wallet-create"
              v-show="!viewBtn"
