      ...
      <div class="left-part">
        ...
        <div class="voted-container">
          <div class="visiter-approve" v-if="!isVoter">
            <a-icon type="caret-up" class="icon-approve" />
          ...
          <div class="visiter-reject" v-if="!isVoter">
            <a-icon type="caret-down" class="icon-reject" />
          ...
          >
            <p>
              <a-icon type="caret-up" class="icon-approve" />
              <span
                :class="{ 'my-voted-text': myVoted === MY_VOTED.APPROVED }"
                class="total-voted"
                >{{ vote.approves }}</span
              >
              <span
            ...
            <p class="vote-option" v-if="myVoted !== MY_VOTED.APPROVED">
              Vote Up
            </p>
            <p
              class="my-voted my-voted-approve"
              v-if="myVoted === MY_VOTED.APPROVED"
            >
              <span>Voted</span>
              <span class="added-votes"> +{{ my_weight }}</span>
            </p>
          </div>
          <div
            class="not-voted"
          ...
          >
            <p>
              <a-icon type="caret-down" class="icon-reject" />
              <span
                :class="{ 'my-voted-text': myVoted === MY_VOTED.REJECTED }"
                class="total-voted"
                >{{ vote.rejects }}</span
              >
              <span
            ...
            <p
              class="my-voted my-voted-reject"
              v-if="myVoted === MY_VOTED.REJECTED"
            >
              <span>Voted</span>
              <span class="added-votes"> +{{ my_weight }}</span>
            </p>
            <p class="vote-option" v-if="myVoted !== MY_VOTED.REJECTED">
              Vote Down
            </p>
          </div>
        </div>
