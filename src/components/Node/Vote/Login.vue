  ...
  <div>
    ...
    <div class="auth-login">
      <div class="intro-item">
        ...
        <a-radio-group
          @change="changeVoteWallet"
          v-model="voteWalletType"
        ...
        <div class="import-tip">
          ...
          <span class="darkmode-ignore" @click="hereImport">{{
            $t('vote.importHere')
          }}</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    handleChangePayer(value) {
      this.voteWallet = this.normalWallet.find(v => {
    ...
    next() {
      ...
      if (
        this.voteWalletType === 'ledgerWallet' &&
      ...
      this.$store.commit('UPDATE_VOTE_WALLET_TYPE', {
        type: this.voteWalletType,
      });
